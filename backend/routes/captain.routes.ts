...
import { captainRegisterSchema, validate, captainloginSchema } from '../middlewares/validate';
import { captainProfile, loginCaptain, logout, register } from '../controllers/captain';
