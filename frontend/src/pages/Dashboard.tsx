...
export function Dashboard() {
    ...
    useEffect(()=>{
        if(rideSummaryPanel){
            gsap.to(rideSummaryPanelRef.current,{
                y : 0,
                onComplete : ()=>{console.log('ride summary panel completed');}
            })
        }
        else{
            gsap.to(rideSummaryPanelRef.current,{
    ...
    return (
        <div className="h-screen">
            ...
            <div ref={rideSummaryPanelRef} className="bg-red-500 fixed w-full translate-y-full bg-white px-3 py-10 pt-12"
            style={{zIndex:9999}}>
                this is ride summary panel ... why is this not visible
            </div>
